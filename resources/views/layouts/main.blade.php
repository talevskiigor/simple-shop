        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle ацтиве" aria-current="page" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <form class="d-flex form-inline">
                <a href="/cart" class="btn btn-outline-success my-2 my-sm-0" type="submit"><i class="bi bi-cart-check"></i> Кошница
                    <span class="badge rounded-pill bg-danger">{{\Cart::session(session(\App\helpers\ShoppingCart::SHOPPING_CART_ID,Ramsey\Uuid\Uuid::uuid4()->toString()))->getTotalQuantity()}}</span>
                </a>
    ...
    <div class="bg-white border rounded-5">
        ...
        <div class="p-4 text-center border-top mobile-hidden">
            ...
            <div class="text-center p-4" >
                    ...
                    Copyright © {{\Carbon\Carbon::now()->year}}  <a class="text-reset fw-bold" href="https://forkids.mk/">ForKids.MK</a><br>
